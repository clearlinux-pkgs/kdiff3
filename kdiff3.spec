...
Source0  : https://download.kde.org/stable/kdiff3/kdiff3-1.10.6.tar.xz
Source1  : https://download.kde.org/stable/kdiff3/kdiff3-1.10.6.tar.xz.sig
...
%prep
%setup -q -n kdiff3-1.10.6
cd %{_builddir}/kdiff3-1.10.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699916956
mkdir -p clr-build
pushd clr-build
